...
const path = require('path'); // 新增：用於處理檔案路徑
const app = express();
const PORT = 3000;
...
// ⭐【新增】自動託管靜態網頁檔案
// 這行會讓 Express 自動去讀取同層級下 `public` 資料夾內的所有網頁（index.html, admin.html 等）
...
app.listen(PORT, () => {
    ...
    console.log(` 點餐大廳請開: http://localhost:${PORT}/index.html`);
    console.log(` 後台管理請開: http://localhost:${PORT}/admin.html`);
    console.log(`---------------------------------------------`);
